# ETF EASY
#### Video Demo:  https://youtu.be/Eipp-IzLUso
#### Description:
1. Project Description: <br/>
    My web application is a portfolio management system. Its target customers are unexperienced investors and the goal is to give them a simple possibility to manage there portfolio with an easy to understand and transparent strategy. Because the target customers are assumed to be unexperienced, the underlying instruments should be ETFs as they are diversified instruments opposed to individual stocks and therefore having less underlying risk. Though it would be possible to use the application for managing individual stocks as well.<br/>
    It supports three types of risk views, the first is the risk averse view, the second the balanced risk view and the third the risk seeking view. This means depending on the risk appetite of the customer, he/she can use different portfolio management strategies. E.g., the risk averse person will choose to invest his/her money in 70% of a riskless component and 30% in a more risky component, the balanced risk view or risk appetite of a person will invest 50% in a riskless component and 50% in a more risky component and finally the risk seeking person will invest only 30% of a riskless component and most of his money , i.e., 70%; in a more risky component. By saying riskless component an ETF with an underlying fixed income instrument is meant and with a more risky component an ETF with stocks as underlying are meant (it is clear that also the riskless component has inherent risk). When registering for this application the user decided his username, password and what risk type he/she belongs to.<br/>
    Because this positions are self managed by the user, he/she needs to decide what is defined to be a riskless ETF and what is defined to be a risky ETF. This is done when the user sets up his position by buying certain ETFs and defining them as High or Low risk.<br/>
    After login, the application knows what risk type (risk averse, balance, risk seeking) the user belongs to, as during registration the user has defined his/her risk type. Also the user is directly led to the position page, giving him/her an overview of his/her position. The user logged in is alerted when his position is out of range w.r.t. the thresholds connected to his/her chosen risk view (risk averse, balanced, risk seeking) and give advise how to get back to the chosen risk appetite. 


2. Content of the implemented files: <br/>
    - **app.py**: flask file linking all files together
    - **layout.html**: This file defines the overall layout of the webpages with navigation bar and footer, the main blog is then individually constructed in the other html pages.
    - **FirstPage_ETF.html**: Landing Page of the user. Gives a short Description what the applications does and what is meant with ETF EASY - Portfoliomanagement, i.e. what is meant with portfolio management for a risk averse, balance or risk seeking view. Once the user has decided what type of view or risk appetite he/she wants to take, the landing page directs you to register as risk avers, balanced or risk seeking person. 
    - **login.html**: Once registered as risk avers, balanced or risk seeking the user has to log in with his username and password. The application links the percentage split linked to the risk appetites to the user, i.e., if the user logs in the application knows what risk appetite the user has.
    ...
    - **register_ETF.html**: When approaching the registration page via the navigation bar, not only the user and password has to be defined, but also the risk strategy, i.e. risk averse, balanced and risk seeking has to be defined. 

    - **register_ETF_averse.html**: This is the registration page, when approaching it via the buttons on the main page. Here no risk strategy has to be defined as the buttons make clear what risk type will be set up, in this case risk averse.

    - **register_ETF_balanced.html**: This is the registration page, when approaching it via the buttons on the main page. Here no risk strategy has to be defined as the buttons make clear what risk type will be set up, in this case balanced.

    - **register_ETF_seeking.html**: This is the registration page, when approaching it via the buttons on the main page. Here no risk strategy has to be defined as the buttons make clear what risk type will be set up, in this case risk seeking.
